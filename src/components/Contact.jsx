      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
            Contact me fpr collaboration
          </h2>
          <p className="text-zinc-400 mt-3 reveal-up mb-8 max-w-[50ch] lg:max-w-[30ch]">
            Reachout today to discuss your project needs and start collaborating
        ...
        <form
          action="https://getform.io/f/arooovob"
          method="POST"
        ...
        >
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="mizanur@example.com"
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder="Hi!"
              required
              className="text-field resize-y min-h-32 reveal-up max-h-80"
            ></textarea>
          </div>
          <button
            type="submit"
            className="btn reveal-up btn-primary [&]:max-w-full w-full justify-center"
          >
            Submit
          </button>
        </form>
